 ...
 */
class getRouting_ResolverService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addLoader(($container->privates['routing.loader.attribute'] ??= new \Symfony\Bundle\FrameworkBundle\Routing\AttributeRouteControllerLoader('prod')));
