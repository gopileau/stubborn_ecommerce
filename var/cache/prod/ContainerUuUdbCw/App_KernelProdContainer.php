...
class App_KernelProdContainer extends Container
{
    ...
    /*
     * Gets the private 'monolog.formatter.json' shared service.
     *
     * @return \Monolog\Formatter\JsonFormatter
     */
    protected static function getMonolog_Formatter_JsonService($container)
    {
        return $container->privates['monolog.formatter.json'] = new \Monolog\Formatter\JsonFormatter();
    }
    ...
    {
        return $container->privates['monolog.handler.main'] = new \Monolog\Handler\FingersCrossedHandler(($container->privates['monolog.handler.nested'] ?? self::getMonolog_Handler_NestedService($container)), ($container->privates['monolog.handler.main.http_code_strategy'] ?? self::getMonolog_Handler_Main_HttpCodeStrategyService($container)), 50, true, true, NULL);
    }
    ...
    {
        $container->privates['monolog.handler.nested'] = $instance = new \Monolog\Handler\StreamHandler('php://stderr', 'debug', true, NULL, false);
    ...
    protected static function getSecurity_ContextListener_1Service($container)
    {
        return $container->privates['security.context_listener.1'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['security.user.provider.concrete.in_database'] ?? $container->load('getSecurity_User_Provider_Concrete_InDatabaseService'));
        }, 1), 'anonymous', ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)), ($container->privates['security.event_dispatcher.anonymous'] ?? self::getSecurity_EventDispatcher_AnonymousService($container)), ($container->privates['security.authentication.trust_resolver'] ??= new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver()), [($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), 'enableUsageTracking']);
    }
    ...
    /*
     * Gets the private 'security.event_dispatcher.anonymous' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    protected static function getSecurity_EventDispatcher_AnonymousService($container)
    {
        $container->privates['security.event_dispatcher.anonymous'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();
