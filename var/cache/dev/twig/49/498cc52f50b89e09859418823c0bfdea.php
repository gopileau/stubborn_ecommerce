...
class __TwigTemplate_2da05c1b7dcffb879e1ba1dee24c05f5 extends Template
{
...
<div class=\"form-container\">
    <h2>Réinitialiser votre mot de passe</h2>
    <form action=\"{{ path('app_forgot_password') }}\" method=\"post\">
        <div class=\"form-group\">
            <label for=\"email\">Email:</label>
            <input type=\"email\" id=\"email\" name=\"email\" required>
        </div>
...
{% endblock %}
", "security/forgot_password.html.twig", "C:\\Windows\\System32\\stubborn_ecommerce\\templates\\security\\forgot_password.html.twig");
    }
}
